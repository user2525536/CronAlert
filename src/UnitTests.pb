...
TestParserFalse(Num(#Null, #False), "-123")
TestParserFalse(NumQ(), "a123456789123456")
TestParserFalse(NumQ(#Null, #False), "-123456789123456")
TestParserFalse(NumF(), "a123.456")
TestParserFalse(NumF(#Null, #False), "-123.456")
TestParserFalse(NumD(), "a123.456789123456")
TestParserFalse(NumD(#Null, #False), "-123.456789123456")
TestParserFalse(NumVal(123), "321")
TestParserFalse(NumVal(123, #Null, #False), "-123")
TestParserFalse(NumQVal(123456789123456), "321,456,789,123,456")
TestParserFalse(NumQVal(123456789123456, #Null, #False), "-123,456,789,123,456")
TestParserFalse(NumFVal(123.456E-2), "321.456E-2")
TestParserFalse(NumFVal(123.456E-2, #Null, #False), "-123.456E-2")
TestParserFalse(NumDVal(123.456E10), "321.456E10")
TestParserFalse(NumDVal(123.456E10, #Null, #False), "-123.456E10")
